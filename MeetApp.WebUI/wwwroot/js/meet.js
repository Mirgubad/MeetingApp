...
chatConnection.on("ReceiveMessage", (senderUsername, senderEmail, message) => {
    const messagesList = document.querySelector("#messages");
    const li = document.createElement("li");
    let checkUser = userEmail === senderEmail;
    ...
    if (checkUser) {
        ...
        li.innerHTML = `<span name>${senderUsername}</span> <p>${message}</p>`;
    }
